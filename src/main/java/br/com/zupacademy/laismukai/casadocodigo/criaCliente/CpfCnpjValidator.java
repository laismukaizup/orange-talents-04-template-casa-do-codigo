...
public class CpfCnpjValidator implements ConstraintValidator<CpfCnpjValue, String> {

    private String domainAttribute;
    private Class<?> klass;

    @Override
    public void initialize(CpfCnpjValue params) {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        boolean cpfIsValid = isCpf(value);
        boolean cnpjIsValid = isCnpj(value);
        /*if(cpfIsValid)
        Assert.state(!cpfIsValid, "CPF inválido");
        if(cnpjIsValid)
            Assert.state(!cnpjIsValid, "CPF inválido");*/
